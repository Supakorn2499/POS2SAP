...
public interface IInterfaceJobService
{
    ...
    Task<(int Sent, int Failed)> TriggerManualAsync(IEnumerable<string>? docNos = null, string? interfaceType = null);
    ...
    Task<(int Fetched, int Imported, string? Error)> ImportPreviewAsync(
